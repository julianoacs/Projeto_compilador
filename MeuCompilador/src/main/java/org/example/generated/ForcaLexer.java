...
public class ForcaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "VAR", "SE", "SENAO", "ENQUANTO", "REPITA", 
			"ATE", "LEIA", "ESCREVA", "PARE", "CONTINUE", "TIPO_INTEIRO", "TIPO_REAL", 
			"TIPO_TEXTO", "OU", "E", "ID", "REAL", "INT", "TEXTO", "ESPACO", "COMLIN", 
			"COMBLO"
		};
	}
	...
	public ForcaLexer(CharStream input) {
		super(input);
